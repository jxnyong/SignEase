...
# Confidence level. For us to render results on if they past a certain threshold
threshold = 0.4
...
def extract_keypoints(results):
    ...
    # In this case, there are 486 landmarks with 3 values, res x, res y ad res z.
...
def predict_action(frames):
    imagesAndResults = [mediapipe_detection(
        frame, holistic) for frame in frames]
...
if __name__ == "__main__":
    ...
    while cap.isOpened():
        ...
        if len(sequence) == 30:
            ...
            # Ensuring there are no wrong prediction during transitions
