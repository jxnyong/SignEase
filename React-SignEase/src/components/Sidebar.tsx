...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <div>
      ...
      {/* Only render this link if user is not logged in */}
      {!userLogged && (
        <>
          <aside
            ref={sidebar}
              ...
              <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
                ...
                <div>
                  ...
                  <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    {/* <!-- Menu Item SignDictionary --> */}
                    <li>
                      <NavLink
                        to="/signdictionary"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('signdictionary') &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <svg
                ...
                <div>
                  ...
                  <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    {/* <!-- Menu Item Sign Language Videos --> */}
                    <SidebarLinkGroup
              ...
              <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
                ...
                <div>
                  ...
                  <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    {/* <!-- Menu Item TranslationHistory --> */}
                    <li>
                      <NavLink
                        to="/translationhistory"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('translationhistory') &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                      >
                        <svg
