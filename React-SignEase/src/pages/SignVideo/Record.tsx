  ...
  return (
    <>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="w-full flex p-6.5 items-center justify-start">
            ...
            <div className="mb-5.5 mt-10 flex flex-col gap-5.5 sm:flex-row">
              <div className="w-full sm:w-1/4">
                ...
                <div className="relative z-20 bg-white dark:bg-form-input">
                  ...
                  <select className="relative z-20 w-full appearance-none rounded border border-strokewhite bg-transparent py-3 px-12 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input" defaultValue={"english"}>
              ...
              <div className="w-full sm:w-1/4">
                ...
                <div className="relative z-20 bg-white dark:bg-form-input">
                  ...
                  <select className="relative z-20 w-full appearance-none rounded border border-strokewhite bg-transparent py-3 px-12 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input" defaultValue={"gesture"}>
